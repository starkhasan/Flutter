...
class PaymentScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _PaymentScreen();
}
...
class _PaymentScreen extends State<PaymentScreen> {
  ...
  // String _error;
  // final String _currentSecret = "sk_test_51I8QqEDfDl7qjSXOwm41JErAlflWOrpSoqx6rJS2PXAgxRwHNMOE5TOnhoyyBTeW4IrOm1NniG8JOWfjSaWuzcC000h6Y3VX8i";
  ...
  //     StripeOptions(
  //       publishableKey: "pk_test_51I8QqEDfDl7qjSXOzsQwkNWPOS6hUkSe4cuFEzDVaEmHIUK2ZOyBUB4GRf6mGGRUDVvvNDs92cJZ0On3cgk4gX9T00DgMjxfUe",
  //       merchantId: "Test",
  //       androidPayMode: 'test'
  //     )
  //   );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        child: Center(child: Text('Proceed Payment Here')),
      ),
    );
  }
}
